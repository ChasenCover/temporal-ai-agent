...
const ChatWindowLazy = lazy(() => import("../components/ChatWindow"));
            ...
            <div className="flex-grow flex justify-center px-4 py-2 overflow-hidden">
                <div className="w-full max-w-lg bg-white dark:bg-gray-900 p-8 px-3 rounded shadow-md 
                    ...
                    <div ref={containerRef} 
                        ...
                        <Suspense fallback={<div className="flex-grow flex items-center justify-center"><span>Loading chat…</span></div>}>
                            <ChatWindowLazy 
